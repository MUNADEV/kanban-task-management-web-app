    ...
    >
      <div className={`task-modal ${isDeleteModalOpen && "none"}`}>
        <div className="task-modal-title-container">
          <p data-test="task-d-name" className="heading-L">{task.title}</p>
          <img
        ...
        <p data-test="task-d-description" className="task-description text-L">{task.description}</p>
